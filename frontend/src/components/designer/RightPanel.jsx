...
const RightPanel = () => {
  ...
  return (
    <div className="w-full lg:w-[300px] h-auto lg:h-full lg:overflow-y-auto bg-white border-t lg:border-t-0 lg:border-l border-gray-200 text-gray-700 flex flex-col shadow-xl z-20 shrink-0 order-3">
