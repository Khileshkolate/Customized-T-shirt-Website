        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={addToCart}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-600 to-secondary-600 text-white rounded-lg font-semibold hover:from-primary-700 hover:to-secondary-700 transition-all shadow-lg hover:shadow-xl"
              >
              ...
              <div className="pt-6 border-t border-gray-200">
                ...
                {activeTool === 'text' && (
                  <div className="space-y-4">
                    ...
                    <button
                      onClick={addText}
                      className="w-full py-3 bg-gradient-to-r from-primary-600 to-secondary-600 text-white rounded-lg font-semibold hover:from-primary-700 hover:to-secondary-700 transition-all"
                    >
                      Add Text to Design
                    </button>
                  </div>
                ...
                <div className="mt-4 space-y-2">
                  ...
                  {quantity >= 3 && quantity < 5 && (
                    <div className="p-2 bg-secondary-50 border border-secondary-200 rounded-lg">
                      <div className="flex items-center justify-between">
                        <span className="text-secondary-700 font-medium">5% Quantity Discount</span>
                        <span className="text-secondary-600 font-bold">Save 5%</span>
                      </div>
                    </div>
                  )}
                </div>
